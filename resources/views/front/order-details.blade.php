    ...
    <div class="box-collapse">
        ...
        <div class="box-collapse-wrap form">
            ...
            <div class="flex-shrink-0 bg-white">
                <a href="index.html" class="d-flex align-items-left pb-3 mb-3 link-dark text-decoration-none border-bottom">
        ...
        <section class="OrderDetails section-t8 p-top">
            <div class="container">
                <div class="title-wrap d-flex justify-content-between">
                    <div class="title-box">
                        <h2 class="title-a">Order Details</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 col-md-7 col-12">
                        <div class="card p-2">
                            ...
                            <div class="DetailsBox">
                                <div class="imgCart">
                                    <img src="/front/assets/img/1_03.jpg" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="textCart">
                                    <div class="card-body">
                                        <h3 class="p-price">$39.90</h3>
                                        <h6>iTunes</h6>
                                        <h2 class="p-title">FIFA 21 | Next Level Speed</h2>
                        ...
                        <div class="card DetailsPriceBox">
                            <div class="card-header">
                                <div class=" d-flex justify-content-between">
                                    ...
                                    <h6 class="card-text">#4234234</h6>
                                </div>
                                <div class=" d-flex justify-content-between">
                                    <p class="card-text">The date of application

                                    </p>
                                    <h6 class="card-text">December 22 2012</h6>
                                </div>
                            </div>
                            ...
                            <div class="PaymentMethod m-3"><i class="bi bi-credit-card-2-front"></i>Visa or MasterCard</div>
