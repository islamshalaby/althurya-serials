        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="/admin-panel">
                        <img src="https://res.cloudinary.com/{{ cloudinary_app_name() }}/image/upload/w_50/v1581928924/<?=Auth::user()->custom['setting']['logo']?>" class="navbar-logo" alt="logo">
                    </a>
                </li>
        ...
        <div class="search-overlay"></div>
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    {{-- <li class="menu like-card">
                        <a href="{{ route('likeCard.index') }}" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-airplay"><path d="M5 17H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-1"></path><polygon points="12 15 17 21 7 21 12 15"></polygon></svg>
                                <span>{{ __('messages.like_card') }}</span>
                            </div>
                        </a>
                    </li> --}}
                   @if(in_array(1 , Auth::user()->custom['admin_permission']))
                    ...
                    <li class="menu app_pages">
                        ...
                        <ul class="collapse submenu list-unstyled" id="app_pages" data-parent="#accordionExample">
                            ...
                            <li class="privacy" >
                                <a href="/admin-panel/app_pages/privacy">{{ __('messages.privacy') }}</a>
                            </li>
                    ...
                    <li class="menu sliders">
                        <a href="#sliders" data-active="true" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle first-link">
                            <div class="">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="sliders" data-parent="#accordionExample">
                            <li class="show" >
                                <a href="{{ route('sliders.edit', 3) }}"> {{ __('messages.app_sliders') }} </a>
                            </li>
                            {{-- <li class="show" >
                                <a href="{{ route('sliders.edit', 3) }}"> {{ __('messages.web_sliders') }} </a>
                            </li> --}}
                            
                            <li class="active web">
                                <a href="{{ route('sliders.web.show') }}"> {{ __('messages.web_sliders') }} </a>
                            </li>
                    ...
                    <li class="menu products">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="products" data-parent="#accordionExample">
                            @if(Auth::user()->add_data)
                                ...
                                <li class="like-card" >
                                    <a href="{{ route('likeCard.categories') }}"> {{ __('messages.like_card') }} </a>
                                </li>
                            @endif
                            <li class="show" >
                            ...
                            <li class="offers" >
                                <a href="{{ route('products.getOffers', ['recent']) }}"> {{ __('messages.recent_offers') }} </a>
                            </li>
                            <li class="offers" >
                                <a href="{{ route('products.getOffers', ['choose']) }}"> {{ __('messages.choose_for_you_offers') }} </a>
                            </li>
                        </ul>
                    </li>
                    @endif
                    ...
                    {{-- <li class="menu cats">
                        <a href="{{ route('likeCard.categories') }}" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
                                <span>like card</span>
                            </div>
